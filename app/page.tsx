...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Features Section */}
      <section id="features" className="container px-4 lg:px-8 max-w-7xl mx-auto space-y-6 py-12 md:py-24">
      ...
      <section id="how-it-works" className="border-t border-border/50">
        <div className="container px-4 lg:px-8 max-w-7xl mx-auto space-y-6 py-12 md:py-24">
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
